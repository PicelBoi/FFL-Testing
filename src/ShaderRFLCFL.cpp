...
void ShaderRFLCFL::initialize()
{
    mBodyShader.load("RFLBodyShader");

    mShader.load("RFLShader", rio::Shader::MODE_UNIFORM_REGISTER);
...
void ShaderRFLCFL::setShaderCallback_()
{
    FFLSetShaderCallback(&mCallback);
}

void ShaderRFLCFL::bind(bool light_enable, FFLiCharInfo* pCharInfo)
{
...
void ShaderRFLCFL::setViewUniform(const rio::BaseMtx34f& model_mtx, const rio::BaseMtx34f& view_mtx, const rio::BaseMtx44f& proj_mtx) const
{
...
void ShaderRFLCFL::setViewUniformBody(const rio::BaseMtx34f& model_mtx, const rio::BaseMtx34f& view_mtx, const rio::BaseMtx44f& proj_mtx) const {
    if (!mLightEnableBody)
...
void ShaderRFLCFL::applyAlphaTest(bool enable, rio::Graphics::CompareFunc func, f32 ref) const
{
#if RIO_IS_CAFE
...
void ShaderRFLCFL::setCulling(FFLCullMode mode)
{
...
void ShaderRFLCFL::applyAlphaTestCallback_(void* p_obj, bool enable, rio::Graphics::CompareFunc func, f32 ref)
{
    static_cast<Shader*>(p_obj)->applyAlphaTest(enable, func, ref);
}

void ShaderRFLCFL::bindTexture_(const FFLModulateParam& modulateParam)
{
...
void ShaderRFLCFL::setConstColor_(u32 ps_loc, const FFLColor& color)
{
    mShader.setUniform(getColorUniform(color), u32(-1), ps_loc);
}

void ShaderRFLCFL::setModulateMode_(FFLModulateMode mode)
{
    mShader.setUniform(s32(mode), u32(-1), mPixelUniformLocation[PIXEL_UNIFORM_MODE]);
}

void ShaderRFLCFL::setModulate_(const FFLModulateParam& modulateParam)
{
...
void ShaderRFLCFL::setMaterial_(const FFLModulateType modulateType)
{
...
void ShaderRFLCFL::bindBodyShader(bool light_enable, FFLiCharInfo* pCharInfo)
{
    // FAVORITE COLOR
...
void ShaderRFLCFL::draw_(const FFLDrawParam& draw_param)
{
...
void ShaderRFLCFL::drawCallback_(void* p_obj, const FFLDrawParam& draw_param)
{
    static_cast<Shader*>(p_obj)->draw_(draw_param);
}

void ShaderRFLCFL::setMatrix_(const rio::BaseMtx44f& matrix)
{
...
void ShaderRFLCFL::setMatrixCallback_(void* p_obj, const rio::BaseMtx44f& matrix)
{
